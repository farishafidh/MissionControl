...
- Agent spawning and management (3 Hermes instances)
- Basic REST API
- SQLite database setup

### Phase 2 — Chat System
- Individual agent chat (user ↔ agent DMs)
- Group chat (agent ↔ agent)
- Idle chat scheduler (configurable frequency)
- WebSocket for real-time updates

### Phase 3 — Kanban Board
- Task CRUD (create, update, complete)
- Agent self-reporting status
- Visual kanban in the UI
